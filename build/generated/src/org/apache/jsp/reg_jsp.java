...
public final class reg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      _jspx_th_sql_update_0.setVar("user");
      ...
      try {
        ...
        if (_jspx_eval_sql_update_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\n");
            out.write("            INSERT into register VALUES(");
            out.print(id);
            out.write(',');
            out.write('\'');
            out.print(name);
  ...
  private boolean _jspx_meth_sql_setDataSource_0(PageContext _jspx_page_context)
    ...
    _jspx_th_sql_setDataSource_0.setDriver("com.mysql.cj.jdbc.Driver");
    _jspx_th_sql_setDataSource_0.setUrl("jdbc:mysql://localhost:3306/stdb");
    _jspx_th_sql_setDataSource_0.setUser("root");
    _jspx_th_sql_setDataSource_0.setPassword("nclc123");
